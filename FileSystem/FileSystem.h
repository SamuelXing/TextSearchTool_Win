...
* ====================
* ver 2.3 : 07 Jun 13
* - added option to return fully qualified file names from getFiles.
*   Default is still to return just file name.
* ver 2.2 : 23 Feb 13
...
namespace FileSystem
{
	...
	public:
		...
		static std::string selectFile(const std::string& file1, const std::string& file2, bool showCurrPath = false);
	private:
		std::string name_;
	...
	public:
		...
		static std::string selectPath(const std::string& path1, const std::string& path2, bool showCurrPath = false);
	};
